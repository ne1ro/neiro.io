...
To show examples of Ramda.js using, i will use io.js 3.2 and Babel, so let's create new _.js_ file:
...
Like the _Underscore_ and _Lodash_, Ramda has collection helper functions:
...
```javascript
let tripleMultiply = (a, b, c) => a _ b _ c;
...
Pattern matching is also available through _R.cond_. That allows you to check sequence of conditions to match different patterns:
