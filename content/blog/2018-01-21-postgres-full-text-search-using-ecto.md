...
Also we need to allow to search by prefix - beginning of the word. Let's add :_ to our search term_:
...
But this result won't be as fast as we wanted. Let's suppose that we have _11K_ users:
