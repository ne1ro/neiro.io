...
As we know, functional programming in JavaScript is not the best experience, unlike the plain functional languages (_Haskell, Lisp, etc_). But new standards of JavaScript - ES6 _(ECMAScript 2015)_ and _ES7(ECMAScript 2016)_ introduce some improvements and allows you to write code in more functional style:
